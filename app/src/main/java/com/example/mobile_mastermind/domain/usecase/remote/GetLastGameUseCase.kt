...
class GetLastGameUseCase @Inject constructor(private val dataProvider: DataProvider) {
    operator fun invoke(): Flow<BaseResponse<LastGameModel>> {
        return dataProvider.getLastGame()
    }
}